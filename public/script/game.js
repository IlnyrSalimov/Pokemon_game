...
window.onload = function() {
    ...
    //main sound
    var mainTheme = new Audio('assets/main-theme.mp3');
    mainTheme.loop = true;
    ...
    muteBtn.addEventListener('click', function() {
        if (checkMute === false) {
            mainTheme.play();
            muteBtn.innerText = 'Выключить';
            checkMute = true;
        } else {
            mainTheme.pause();
            muteBtn.innerText = 'Включить';
            checkMute = false;
        }
     ...
     */
    var player = {
        x: Math.round(w / objectSizes) - 19,
        y: Math.round(h / objectSizes) - 16,
    ...
    document.onkeydown = function(e) {
        ...
        else if (e.keyCode == '65') player.move('A')
        else if (e.keyCode == '80') player.move('P')
        else if (e.keyCode == '73') player.move('I')
